...
public class ConfirmDeletionDialog {
    ...
    // Static function used for show a Confirmation dialog when user select Delete dashboard
    public static void showConfirmDeleteDialogForDashboard(Activity sourceActivity, DashBoard dashboard, DatabaseAdapter databaseAdapter){
        ...
        confirmCancelDialog = new AlertDialog.Builder(sourceActivity)
                ...
                .setPositiveButton("Yes",
                        new ConfirmDeleteDialogForDashboardPositiveButtonListener(sourceActivity, dashboard, databaseAdapter))
    ...
    private static class ConfirmDeleteDialogForDashboardPositiveButtonListener implements OnClickListener{
        ...
        // constructor
        public ConfirmDeleteDialogForDashboardPositiveButtonListener(Activity sourceActivity, DashBoard dashboard, DatabaseAdapter databaseAdapter){
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            databaseAdapter.deleteDashboard(dashboard);
